...
public class ResultsActivity extends SherlockActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Weird error
		String artist = obj.getSongTitle();
		String title = obj.getSongArtist();
		...
		btn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				(new SendMessageDBPoints()).execute(phone, "" + points);
	...
	private class SendMessageDBPoints extends AsyncTask<String, Integer, Boolean> {
	    ...
	    protected Boolean doInBackground(String... params) {
	    	...
	    	Integer points = Integer.parseInt(params[1]);
